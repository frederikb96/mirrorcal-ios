    ...
    final class DebugRouterTests: XCTestCase {
        ...
        func testIncompleteHeadIsNotParsedYet() async {
        ...
        func testBodyShorterThanContentLengthIsNotParsedYet() async {
        ...
        func testUnknownRouteNamesTheRoutesThatExist() async {
        ...
        /// different here.
        func testTrailingSlashMatchesTheSameRoute() async {
            var router = DebugRouter()
        ...
        func testMethodIsPartOfTheRouteIdentity() async {
            var router = DebugRouter()
        ...
        func testSerializedResponseDeclaresItsRealLength() async {
        ...
        func testEncodedResponseLeavesSlashesAlone() async {
    ...
    final class DebugLogBufferTests: XCTestCase {
        ...
        func testBufferKeepsTheMostRecentEntries() async {
        ...
        func testLevelFilterIsAThresholdNotAnExactMatch() async {
